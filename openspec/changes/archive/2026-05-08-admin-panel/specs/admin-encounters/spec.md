...
The admin encounters page SHALL allow the admin to search for a Pokémon by name, view its current encounter rows in a table, and add, edit, or delete rows inline.
