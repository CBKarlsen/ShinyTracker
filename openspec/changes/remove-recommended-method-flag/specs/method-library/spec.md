...
- **THEN** the response is a JSON array of all encounters with fields: `id`, `game_id`, `game_title`, `method_name`, `base_rolls`, `charm_rolls`, `avg_time_seconds`
...
- **THEN** it shows the method name, base rolls, charm rolls, and avg time per encounter (formatted as seconds or minutes)
