# game-specific-methods Specification

## Purpose
Defines how hunting methods are mapped to specific games (via a join table rather than generation inference), and how that mapping combines with per-Pokémon encounter kinds to determine method availability.
## Requirements
